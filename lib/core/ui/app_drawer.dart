...
const List<NavSection> _navSections = [
  ...
  NavSection(
    title: 'Inspections',
    items: [
      NavItem('All Inspections', Icons.fact_check_outlined, '/inspections',
          description: 'View inspection history'),
      NavItem('Create Inspection', Icons.add_circle_outline, '/inspection/new',
          description: 'Start a new inspection'),
      NavItem('Pending Reviews', Icons.pending_actions_outlined, '/inspections/pending',
  ...
  NavSection(
    title: 'Maintenance',
    items: [
      NavItem('All Jobs', Icons.work_outline, '/maintenance',
          description: 'View all maintenance jobs'),
      NavItem('Schedule', Icons.calendar_month_outlined, '/schedule',
          description: 'Maintenance schedule'),
      NavItem('Create Job', Icons.add_task_outlined, '/maintenance/new',
  ...
  NavSection(
    title: 'Equipment',
    items: [
      NavItem('Registry', Icons.inventory_2_outlined, '/nameplate-list',
          description: 'Equipment database'),
      NavItem('Asset Search', Icons.search_outlined, '/equipment/search',
  ...
  NavSection(
    title: 'System',
    items: [
      NavItem('Configuration', Icons.tune_outlined, '/selection-management',
          description: 'System configuration'),
      NavItem('Settings', Icons.settings_outlined, '/settings',
          description: 'App settings'),
      NavItem('About', Icons.info_outline, '/about',
...
const List<NavItem> _quickActions = [
  NavItem('Create Inspection', Icons.add_circle, '/inspection/new'),
...
class AppUserProfile {
  ...
  final String? role; // Optional user role
...
class AppDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isCompact) {
      return _buildCompactDrawer(context, current);
    }

    return _buildNavigationRail(context, current, isExtended);
  }

  /// Compact drawer for mobile
  Widget _buildCompactDrawer(BuildContext context, String current) {
    return Drawer(
      child: SafeArea(
        child: Column(
          children: [
            ...
            if (showQuickActions) _QuickActionsBar(
  ...
  Widget _buildNavigationRail(BuildContext context, String current, bool isExtended) {
    // Flatten all items for rail
    final allItems = _navSections.expand((s) => s.items).toList();
      ...
      child: Row(
        children: [
          NavigationRail(
            ...
            selectedIndex: selectedIndex.clamp(0, allItems.length - 1),
            onDestinationSelected: (i) => _goTo(context, allItems[i].route),
            leading: Padding(
            ...
            trailing: trailing ??
                (userProfile != null
                  ...
                  child: _ProfileMini(userProfile!, onSwitchTenant),
                )
                    : null),
            destinations: [
              ...
              for (final t in profile.tenants)
                PopupMenuItem(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        t == profile.currentTenant ? Icons.check_circle : Icons.circle_outlined,
                        size: 20,
