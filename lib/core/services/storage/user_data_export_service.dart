...
///
/// Uses the existing lossless inspection/load-test payload builder in
/// [BackupService], then hands the bytes to the platform save dialog. The web
/// implementation of file_picker triggers a browser download.
