...
/// Model for badge data across the app
class AppBadges {
...
/// Provider that calculates badge counts from inspection data
final appBadgesProvider = Provider<AppBadges>((ref) {
  ...
  // Count pending inspections (you can define your own logic)
  // For example, inspections without nameplate data or recent ones
  final pending = inspections.where((ins) {
    // TODO: Define your pending logic
