...
final userProfileProvider = Provider<AppUserProfile?>((ref) {
  // TODO: Replace with actual user infra from your auth service
...
/// In a real app, this would update the backend and refresh relevant infra
class TenantNotifier extends StateNotifier<String> {
  TenantNotifier() : super('Acme Corp');

  void switchTenant(String newTenant) {
    state = newTenant;
    // TODO: Implement actual tenant switching controllers:
    // - Update backend/API
    // - Refresh inspections and other tenant-specific infra
