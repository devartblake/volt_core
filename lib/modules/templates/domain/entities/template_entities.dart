...
class FormTemplateDefinition {
  FormTemplateDefinition({
    ...
    required Iterable<FormTemplateFieldOption> options,
        ...
        fields = List.unmodifiable(
          (fields.toList()..sort((a, b) => a.position.compareTo(b.position))),
        ),
        options = List.unmodifiable(
          (options.toList()..sort((a, b) => a.position.compareTo(b.position))),
        ) {
  ...
  List<FormTemplateField> fieldsForSection(String sectionId) => fields
